<?php
/**
 * File for DukcapilWsdlClass to communicate with SOAP service
 * @package Dukcapil
 ...
 */
/**
 * DukcapilWsdlClass to communicate with SOAP service
 * 
 * @package Dukcapil
 * @author WsdlToPhp Team <contact@wsdltophp.com>
 * @version 20150429-01
 * @date 2016-02-27
 */
class DukcapilWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'http://dwh.dukcapil.kemendagri.go.id:8000/Webservice/ektpStat/EKTPStat.svc?wsdl';
    /**
    ...
    /**
     * Constructor
     * @uses DukcapilWsdlClass::setLastError()
     * @uses DukcapilWsdlClass::initSoapClient()
     * @uses DukcapilWsdlClass::initInternArrayToIterate()
     * @uses DukcapilWsdlClass::_set()
    ...
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'DukcapilWsdlClass'))
            {
     ...
     * @uses DukcapilClassMap::classMap()
     * @uses DukcapilWsdlClass::getDefaultWsdlOptions()
     * @uses DukcapilWsdlClass::getSoapClientClassName()
     * @uses DukcapilWsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if(class_exists('DukcapilClassMap',true))
        {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = DukcapilClassMap::classMap();
     ...
     * If a class is named as {Dukcapil}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('DukcapilSoapClient') && is_subclass_of('DukcapilSoapClient','SoapClient'))
            return 'DukcapilSoapClient';
        else
            return 'SoapClient';
    }
    /**
     * Method returning all default options values
     * @uses DukcapilWsdlClass::WSDL_CACHE_WSDL
     * @uses DukcapilWsdlClass::WSDL_COMPRESSION
     * @uses DukcapilWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses DukcapilWsdlClass::WSDL_ENCODING
     * @uses DukcapilWsdlClass::WSDL_EXCEPTIONS
     * @uses DukcapilWsdlClass::WSDL_FEATURES
     * @uses DukcapilWsdlClass::WSDL_LOGIN
     * @uses DukcapilWsdlClass::WSDL_PASSWORD
     * @uses DukcapilWsdlClass::WSDL_SOAP_VERSION
     * @uses DukcapilWsdlClass::WSDL_STREAM_CONTEXT
     * @uses DukcapilWsdlClass::WSDL_TRACE
     * @uses DukcapilWsdlClass::WSDL_TYPEMAP
     * @uses DukcapilWsdlClass::WSDL_URL
     * @uses DukcapilWsdlClass::VALUE_WSDL_URL
     * @uses DukcapilWsdlClass::WSDL_USER_AGENT
     * @uses DukcapilWsdlClass::WSDL_PROXY_HOST
     * @uses DukcapilWsdlClass::WSDL_PROXY_PORT
     * @uses DukcapilWsdlClass::WSDL_PROXY_LOGIN
     * @uses DukcapilWsdlClass::WSDL_PROXY_PASSWORD
     * @uses DukcapilWsdlClass::WSDL_LOCAL_CERT
     * @uses DukcapilWsdlClass::WSDL_PASSPHRASE
     * @uses DukcapilWsdlClass::WSDL_AUTHENTICATION
     * @uses DukcapilWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses DukcapilWsdlClass::getSoapClient()
     * @uses DukcapilWsdlClass::getFormatedXml()
     ...
     * @uses DukcapilWsdlClass::getSoapClient()
     * @uses DukcapilWsdlClass::convertStringHeadersToArray()
     ...
     * @uses DukcapilWsdlClass::getInternArrayToIterate()
     * @uses DukcapilWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses DukcapilWsdlClass::offsetGet()
     * @return mixed
     */
     ...
     * @uses DukcapilWsdlClass::getInternArrayToIterateOffset()
     * @uses DukcapilWsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses DukcapilWsdlClass::getInternArrayToIterateOffset()
     * @uses DukcapilWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @see DukcapilWsdlClass::offsetGet()
     * @uses DukcapilWsdlClass::offsetGet()
     * @param int $_index
     * @return mixed
     */
     ...
     * @uses DukcapilWsdlClass::getAttributeName()
     * @uses DukcapilWsdlClass::__toString()
     * @uses DukcapilWsdlClass::_set()
     * @uses DukcapilWsdlClass::_get()
     * @uses DukcapilWsdlClass::setInternArrayToIterate()
     * @uses DukcapilWsdlClass::setInternArrayToIterateIsArray()
     * @uses DukcapilWsdlClass::setInternArrayToIterateOffset()
